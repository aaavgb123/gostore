	...
	return (
		<main className="container py-8 max-w-3xl mx-auto">
			...
			<section className="mb-8">
				<p className="mb-4">
					This Cookie Policy explains how we use cookies and similar technologies on our website. By using our
					site, you agree to our use of cookies as described in this policy.
				</p>
			</section>
			{/* What are cookies */}
			<section className="mb-8">
				...
				<p>
					Cookies are small text files that are placed on your device to help the website function and provide
			...
			<section className="mb-8">
				...
				<p>
					For the full cookie policy, please contact our support team or visit our website for the latest
					updates.
				</p>
			</section>
		</main>
