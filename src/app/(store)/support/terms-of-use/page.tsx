	...
	return (
		<main className="container py-8 max-w-3xl mx-auto">
			...
			<section className="mb-8">
				<p className="mb-4">
					By accessing or using our website, you agree to be bound by these Terms of Use. Please read them
					carefully. We may update these terms from time to time, so please check this page regularly.
				</p>
			</section>
			{/* Use of the site */}
			<section className="mb-8">
				...
				<ul className="list-disc ml-6 space-y-1">
					...
					<li>
						We reserve the right to restrict or terminate your access to the site at any time without notice.
					</li>
				</ul>
			</section>
			...
			<section className="mb-8">
				...
				<ul className="list-disc ml-6 space-y-1">
					<li>
						All content on this site, including text, graphics, logos, and images, is the property of Go Store
						or its licensors.
					</li>
			...
			<section className="mb-8">
				...
				<p>
					For the full terms of use, please contact our support team or visit our website for the latest
					updates.
				</p>
			</section>
		</main>
