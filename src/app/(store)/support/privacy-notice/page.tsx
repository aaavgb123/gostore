	...
	return (
		<main className="container py-8 max-w-3xl mx-auto">
			...
			<section className="mb-8">
				<p className="mb-4">
					Your privacy is important to us. This notice explains how we collect, use, and protect your personal
					information. By using our website, you agree to the terms of this Privacy Notice.
				</p>
			</section>
			...
			<section className="mb-8">
				...
				<ul className="list-disc ml-6 space-y-1">
					<li>
						Information you provide to us directly, such as your name, email address, and payment details.
					</li>
			...
			<section className="mb-8">
				...
				<p>
					For the full privacy notice, please contact our support team or visit our website for the latest
					updates.
				</p>
			</section>
		</main>
