...
export default function OrdersPage() {
	return (
		<main className="container py-8">
			...
			{/* 简要说明 */}
			<p className="mb-4">
				Find answers to your questions about orders and delivery below. If you need more help, please contact
				our support team.
			</p>
			{/* 相关文章列表 */}
			<section className="mb-6">
				...
				<ul className="list-disc ml-6 space-y-1">
					<li>
						<a href="/help/delivery-information" className="text-blue-600 underline">
