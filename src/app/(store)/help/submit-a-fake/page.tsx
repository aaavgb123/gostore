...
export default function SubmitAFakePage() {
	return (
		<main className="container py-8">
			...
			{/* 说明内容 */}
			<p className="mb-4">
				If you suspect you have found a counterfeit product or website, please let us know. Counterfeit
				products can be dangerous and may not meet safety standards. Your report helps us protect our
				community and brand.
			</p>
			{/* 假货危害说明 */}
			...
			<section className="mb-6">
				...
				<p>
					Please contact our support team with details and any evidence (such as website links or photos). We
			...
			<section>
				...
				<p>
					By avoiding fakes and reporting suspicious products, you are helping us protect everyone. Thank you
					for your support!
				</p>
			</section>
		</main>
