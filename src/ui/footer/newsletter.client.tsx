	...
	return (
		<>
			...
			<p className="mt-2 text-sm text-gray-600">
				If you encounter any issues with your newsletter subscription, please contact our support team at <a href="mailto:gostorezhichi@icloud.com" className="text-blue-600 underline">gostorezhichi@icloud.com</a> for assistance.
			</p>
		</>
	);
};
